...
<div class="panel">
  ...
  <div class="panel-heading" role="tab" id="heading<?Php echo $GLOBALS['instance_count'] ?>">
    <a data-toggle="collapse" data-parent="#accordion" href="#collapse<?Php echo $GLOBALS['instance_count'] ?>" aria-expanded="true" aria-controls="collapse<?Php echo $GLOBALS['instance_count'] ?>" class="collapsed">
      ...
      <span class="graphic arrow-panel-gray "></span><?php echo $programinstance_type; ?> - <?php echo get_field('instances')[$GLOBALS['instance_count']]['instances_name']; ?> <?php// echo get_field('instances')[$GLOBALS['instance_count']]['city'] ?><span class="graphic icon-toggle pull-right"></span>
      </h3>
    </a>
  </div>
